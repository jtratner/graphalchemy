# -*- coding: utf-8 -*-
#
# GraphAlchemy documentation build configuration file, created by
...
project = u'GraphAlchemy'
copyright = u'2012, Jeffrey Tratner'
...
htmlhelp_basename = 'GraphAlchemydoc'
...
latex_documents = [
  ('index', 'GraphAlchemy.tex', u'GraphAlchemy Documentation',
   u'Jeffrey Tratner', 'manual'),
]
...
man_pages = [
    ('index', 'graphalchemy', u'GraphAlchemy Documentation',
     [u'Jeffrey Tratner'], 1)
]
...
texinfo_documents = [
  ('index', 'GraphAlchemy', u'GraphAlchemy Documentation',
   u'Jeffrey Tratner', 'GraphAlchemy', 'One line description of project.',
   'Miscellaneous'),
]
